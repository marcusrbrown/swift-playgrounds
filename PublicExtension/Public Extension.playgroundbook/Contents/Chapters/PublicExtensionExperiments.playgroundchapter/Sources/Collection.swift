...
Indices.Iterator.Element == Int {
	...
	public func transpose() -> [[Iterator.Element.Iterator.Element?]] {
...
extension Collection where Index: Comparable, Indices.Iterator.Element == Index {
	public func lastIndexOf(isElement: (Iterator.Element) -> Bool) -> Index? {
...
SubSequence.Iterator.Element == Iterator.Element {
	...
	public func search<Other: Collection>(pat: Other) -> Index?
		where
...
extension Collection where Iterator.Element: Comparable, Index: Integer {
	public func element(after element: Iterator.Element) -> Iterator.Element? {
		guard let
	...
	public func element(before element: Iterator.Element) -> Iterator.Element? {
		guard let
			idx = index(of: element),
...
extension Collection {
	...
	///            contains nonmatches.
	public func partition(_ predicate: (Iterator.Element) -> Bool) -> ([Iterator.Element], [Iterator.Element]) {
