...
extension String {
	public func parseDate(format: String = "yyyy-MM-dd") -> Date? {
...
extension String {
	public func computeReadingTime(readingSpeed: Double = 250) -> Double {
...
extension String {
	...
	public func qrImage(withSize size: CGSize,
...
extension String {
	...
	public subscript(start: UInt, length: UInt) -> String? {
		guard
...
extension String {
	...
	public var s_n_a_k_e_c_a_s_e_d: String { // 😝
